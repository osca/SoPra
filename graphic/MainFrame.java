...

{
...

	{
		...
		homeButton
				.setPreferredSize(new Dimension(BUTTONWIDTH, BUTTONHEIGHT * 2));
		...
		Flug f = new Flug("name", "beschreibung", 23, 23.5,
				new Date[] { new Date() }, "hier", "ziel", "7", "unbezahlbar");
		...
		screen.add(new BuchDetailScreen(new Buchung(new Flug("name",
				"beschreibung", 23, 23.5, new Date[] { new Date() }, "hier",
				"ziel", "7", "unbezahlbar"), new Kunde("name", "email",
				"password"))));
